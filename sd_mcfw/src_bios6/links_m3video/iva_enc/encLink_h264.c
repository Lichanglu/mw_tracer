                                          ...
                                          algCreateParams)
{
    ...
    *staticParams = H264ENC_TI_PARAMS;
	...
	//staticParams->videnc2Params.maxHeight = 1200;
    ...
    Vps_printf("staticParams->videnc2Params.maxHeight =%d staticParams->videnc2Params.maxWidth =%d\n",
...
//    staticParams->videnc2Params.rateControlPreset = IVIDEO_USER_DEFINED;
	staticParams->videnc2Params.rateControlPreset = algCreateParams->rateControlPreset;
...
//	staticParams->maxIntraFrameInterval = 1;
                                           ...
                                           algDynamicParams)
{
    *dynamicParams = H264ENC_TI_DYNAMICPARAMS;
	...
	dynamicParams->intraCodingParams.lumaIntra4x4Enable		= 0x0FF;
	dynamicParams->intraCodingParams.lumaIntra8x8Enable		= 0x0;
	dynamicParams->intraCodingParams.lumaIntra16x16Enable	= 0xF;
	dynamicParams->intraCodingParams.chromaIntra8x8Enable	= 0xF;
	dynamicParams->intraCodingParams.chromaComponentEnable	= IH264_CHROMA_COMPONENT_DEFAULT;
	...
	dynamicParams->intraCodingParams.gdrOverlapRowsBtwFrames	= 0;
	dynamicParams->intraCodingParams.constrainedIntraPredEnable = 0;
	dynamicParams->intraCodingParams.intraCodingBias		= 0;

//	dynamicParams->videnc2DynamicParams.inputWidth = 1920;
  //  dynamicParams->videnc2DynamicParams.inputHeight = 1200;
    //dynamicParams->videnc2DynamicParams.captureWidth = 1920;
    Vps_printf("inputWidth = %d,inputHeight =%d,captureWidth = %d\n",
      dynamicParams->videnc2DynamicParams.inputWidth,dynamicParams->videnc2DynamicParams.inputHeight,\
      dynamicParams->videnc2DynamicParams.captureWidth);
    return 0;
}
                          ...
                          Int linkID, Int channelID, Int scratchGroupID)
{
	...
	enclink_h264_print_dynamic_params(channelID, &hObj->dynamicParams);
    if (!UTILS_ISERROR(retVal))
    {
        algStatus = enclink_h264_control(hObj->algHandle,
                                         XDM_SETPARAMS,
