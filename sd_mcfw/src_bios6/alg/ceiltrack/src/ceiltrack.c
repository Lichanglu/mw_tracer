...
* @ ∑µªÿ÷µ:   Œﬁ
*/
void ceil_track_area_check(CeilTrackHand *inst)
{
...
* @ ∑µªÿ÷µ:   Œﬁ
*/
static int32_t	draw_point(CeilTrackHand *inst,int8_t *buffer, yuv_value_info_t *yuv_value,
...
* @ ∑µªÿ÷µ:   Œﬁ
*/
static int32_t	draw_line(CeilTrackHand *inst,int8_t *buffer,yuv_value_info_t *yuv_value,
...
* @ ∑µªÿ÷µ:	  Œﬁ
*/
static void draw_rectangle(CeilTrackHand *inst,int8_t *buffer,yuv_value_info_t *yuv_value,
	line_info_t *line_info)
{
    int32_t i,j;
...
* @ ∑µªÿ÷µ:	  Œﬁ
*/
static void fill_rectangle(CeilTrackHand *inst,int8_t *buffer,yuv_value_info_t *yuv_value,
	line_info_t *line_info)
{
	int nSrcBufWidth=inst->t_global_obj.nSrcBufWidth;
	int nSrcBufHeight=inst->t_global_obj.nSrcBufHeight;
...
* @ ∑µªÿ÷µ:	  Œﬁ
*/
static void draw_track_rect(CeilTrackHand *inst,int8_t *buffer)
{
...
int32_t ceil_track_set_check_max_rect(CeilTrackHand *inst)
{
	CeilITRACK_Params 	*input_param	= &(inst->input_param);
	int32_t		index	= 0;
...
int32_t ceil_track_get_max_rect(CeilITRACK_Params *pParams, T_Rect *prect)
{
	CeilITRACK_Params 	*input_param	= pParams;
	int32_t		index	= 0;
	int32_t		min_x	= 704;
	int32_t		min_y	= 576;
	int32_t		max_x	= 0;
...
#if 0
static Int32 Draw(CeilTrackHand *inst,int8_t *input_buf, int8_t *output_buf)
{
...
static Int32 Draw_1(CeilTrackHand *inst,int8_t *input_buf, int8_t *output_buf)
{
...
//ª≠UV
static Int32 Draw_2(CeilTrackHand *inst,int8_t *input_buf, int8_t *output_buf)
{
...
//ª≠UV
static Int32 Draw_3(CeilTrackHand *inst,int8_t *input_buf, int8_t *output_buf, int8_t *uv)
{
...
int InterframeDetection(CeilTrackHand *inst,uint8_t *input_buf)
{
	CeilITRACK_Params 	*input_param 	= &(inst->input_param);
	int32_t nSrcBufWidth  = inst->t_global_obj.nSrcBufWidth;
...
int32_t	ceil_track_process(CeilTrackHand *inst,int8_t *input_buf, int8_t *output_buf, 
