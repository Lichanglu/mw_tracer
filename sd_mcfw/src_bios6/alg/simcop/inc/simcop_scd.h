...
typedef struct
{
	    ...
	    Ptr pUpdateMaskMHIUQ8_0;  /* Update Mask from MHI - frame size bytes */
 ...
 *************************************************************************************
 **/
Int32 SCD_process(SCD_Obj *pObj, SCD_ProcessPrm *pPrm, SCD_ProcessStatus *pStatus);
...
Int32 SCD_initMeanVarMHI(SCD_Obj * pObj, SCD_InitMeanVarMHIPrm *pPrm);
