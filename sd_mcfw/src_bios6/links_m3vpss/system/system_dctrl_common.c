...
Int32 System_hdmiConfig(UInt32 displayRes)
{
    ...
    if (displayRes == VSYS_STD_1080I_60)
        modePrms.standard = FVID2_STD_1080I_60;
    if (displayRes == VSYS_STD_1080P_60)
        modePrms.standard = FVID2_STD_1080P_60;
    if (displayRes == VSYS_STD_1080P_50)
        modePrms.standard = FVID2_STD_1080P_50;
    if (displayRes == VSYS_STD_720P_60)
        modePrms.standard = FVID2_STD_720P_60;
    if (displayRes == VSYS_STD_XGA_60)
        modePrms.standard = FVID2_STD_XGA_60;
