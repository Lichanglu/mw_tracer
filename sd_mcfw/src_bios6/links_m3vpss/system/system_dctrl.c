...
Int32 System_getVencMode(Int32 resolution)
{
    ...
    switch(resolution){
        ...
        break;
        case VSYS_STD_1920x1200_60:
            vencMode = FVID2_STD_1920x1200_60;
        break;
        case VSYS_STD_1440_900_60:
           vencMode = FVID2_STD_1440x900_60;
        break;
        case VSYS_STD_1366_768_60:
           vencMode = FVID2_STD_1366x768_60;
        break;
        case VSYS_STD_SXGAP_60:
           vencMode = FVID2_STD_SXGAP_60;
        break;
        case VSYS_STD_1280x800_60:
           vencMode = FVID2_STD_1280x800_60;
        break;
        default:
            vencMode = FVID2_STD_1080P_60;
