...
static int Vps_platformTI816xSetPinMuxForVout1(void)
{
    REG32(CSL_TI816x_CTRL_MODULE_BASE + 0x084c) = 1;   //19  tsi3_pacerr   vout1_b_cb_c2   VIN1_D8
    REG32(CSL_TI816x_CTRL_MODULE_BASE + 0x0814) = 1;   //5   tsi1_dclk     vout1_b_cb_c3   VIN1_D9
    REG32(CSL_TI816x_CTRL_MODULE_BASE + 0x0818) = 1;   //6   tsi1_data     vout1_b_cb_c4   VIN1_D10
    REG32(CSL_TI816x_CTRL_MODULE_BASE + 0x081c) = 1;   //7   tsi1_bytstrt  vout1_b_cb_c5   VIN1_D11
    REG32(CSL_TI816x_CTRL_MODULE_BASE + 0x0820) = 1;   //8   tsi1_pacval   vout1_b_cb_c6   VIN1_D12
    REG32(CSL_TI816x_CTRL_MODULE_BASE + 0x0824) = 1;   //9   tsi1_pacerr   vout1_b_cb_c7   VIN1_D13
    REG32(CSL_TI816x_CTRL_MODULE_BASE + 0x085c) = 3;   //23  tsi4_pacval   VIN0_D18        vin1_fld0       vout1_b_cb_c8
    REG32(CSL_TI816x_CTRL_MODULE_BASE + 0x0860) = 3;   //24  tsi4_pacerr   VIN0_D19        vin1_de0        vout1_b_cb_c9

    REG32(CSL_TI816x_CTRL_MODULE_BASE + 0x08b8) = 1;   //46  tso1_data     vout1_g_y_yc2   VIN1_D0
    REG32(CSL_TI816x_CTRL_MODULE_BASE + 0x08bc) = 1;   //47  tso1_bytstrt  vout1_g_y_yc3   VIN1_D1
    REG32(CSL_TI816x_CTRL_MODULE_BASE + 0x08c0) = 1;   //48  tso1_pacval   vout1_g_y_yc4   VIN1_D2
    REG32(CSL_TI816x_CTRL_MODULE_BASE + 0x08c4) = 1;   //49  tso1_pacerr   vout1_g_y_yc5   VIN1_D3
    REG32(CSL_TI816x_CTRL_MODULE_BASE + 0x083c) = 1;   //15  tsi3_dclk     vout1_g_y_yc6   VIN1_D4
    REG32(CSL_TI816x_CTRL_MODULE_BASE + 0x0840) = 1;   //16  tsi3_data     vout1_g_y_yc7   VIN1_D5
    REG32(CSL_TI816x_CTRL_MODULE_BASE + 0x0844) = 1;   //17  tsi3_bytstrt  vout1_g_y_yc8   VIN1_D6
    REG32(CSL_TI816x_CTRL_MODULE_BASE + 0x0848) = 1;   //18  tsi3_pacval   vout1_g_y_yc9   VIN1_D7

    REG32(CSL_TI816x_CTRL_MODULE_BASE + 0x08b4) = 1;   //45  tso1_dclk     vout1_clk       VIN1_CLK0
    REG32(CSL_TI816x_CTRL_MODULE_BASE + 0x0850) = 1;   //20  tsi4_dclk     vout1_hsync     VIN1_D15
    REG32(CSL_TI816x_CTRL_MODULE_BASE + 0x0854) = 3;   //21  tsi4_data     VIN0_D16        vin1_hsync0     vout1_fld
    REG32(CSL_TI816x_CTRL_MODULE_BASE + 0x0858) = 3;   //22  tsi4_bytstrt  VIN0_D17        vin1_vsync0     vout1_vsync
    REG32(CSL_TI816x_CTRL_MODULE_BASE + 0x0878) = 1;   //30  tsi6_dclk     vout1_avid      VIN1_CLK1

    return 0;	
}

void Vps_platformTI816xPinMuxPrintf(void)
{
	Vps_printf("0x084c = 0x%x",REG32(CSL_TI816x_CTRL_MODULE_BASE + 0x084c));
	Vps_printf("0x0814 = 0x%x",REG32(CSL_TI816x_CTRL_MODULE_BASE + 0x0814));
	Vps_printf("0x0818 = 0x%x",REG32(CSL_TI816x_CTRL_MODULE_BASE + 0x0818));
	Vps_printf("0x081c = 0x%x",REG32(CSL_TI816x_CTRL_MODULE_BASE + 0x081c));
	Vps_printf("0x0820 = 0x%x",REG32(CSL_TI816x_CTRL_MODULE_BASE + 0x0820));
	Vps_printf("0x0824 = 0x%x",REG32(CSL_TI816x_CTRL_MODULE_BASE + 0x0824));
	Vps_printf("0x085c = 0x%x",REG32(CSL_TI816x_CTRL_MODULE_BASE + 0x085c));
	Vps_printf("0x0860 = 0x%x",REG32(CSL_TI816x_CTRL_MODULE_BASE + 0x0860));

	Vps_printf("0x08b8 = 0x%x",REG32(CSL_TI816x_CTRL_MODULE_BASE + 0x08b8));
	Vps_printf("0x08bc = 0x%x",REG32(CSL_TI816x_CTRL_MODULE_BASE + 0x08bc));
	Vps_printf("0x08c0 = 0x%x",REG32(CSL_TI816x_CTRL_MODULE_BASE + 0x08c0));
	Vps_printf("0x08c4 = 0x%x",REG32(CSL_TI816x_CTRL_MODULE_BASE + 0x08c4));
	Vps_printf("0x083c = 0x%x",REG32(CSL_TI816x_CTRL_MODULE_BASE + 0x083c));
	Vps_printf("0x0840 = 0x%x",REG32(CSL_TI816x_CTRL_MODULE_BASE + 0x0840));
	Vps_printf("0x0844 = 0x%x",REG32(CSL_TI816x_CTRL_MODULE_BASE + 0x0844));
	Vps_printf("0x0848 = 0x%x",REG32(CSL_TI816x_CTRL_MODULE_BASE + 0x0848));

	Vps_printf("0x08b4 = 0x%x",REG32(CSL_TI816x_CTRL_MODULE_BASE + 0x08b4));
	Vps_printf("0x0850 = 0x%x",REG32(CSL_TI816x_CTRL_MODULE_BASE + 0x0850));
	Vps_printf("0x0854 = 0x%x",REG32(CSL_TI816x_CTRL_MODULE_BASE + 0x0854));
	Vps_printf("0x0858 = 0x%x",REG32(CSL_TI816x_CTRL_MODULE_BASE + 0x0858));
	Vps_printf("0x0878 = 0x%x",REG32(CSL_TI816x_CTRL_MODULE_BASE + 0x0878));
	Vps_printf("\n");
}

void Vps_platformTI816xHDVPSS(unsigned int base, unsigned int num)
{
	int i;
	for(i=0;i<num;i++){
		Vps_printf("addr 0x%x = 0x%x",(base+i*4), REG32(base + i*4));
	}
	Vps_printf("\n");
}
...
Int32 DisplayLink_drvDisplayCreate(DisplayLink_Obj * pObj)
{
   ...
   else if (pObj->createArgs.displayRes == VSYS_STD_PAL)
    {
        pFormat->width = 720;
        pFormat->height = 576;
    }
    else if (pObj->createArgs.displayRes == VSYS_STD_720P_60)
    {
        pFormat->width = 1280;
        pFormat->height = 720;
    }
	else if (pObj->createArgs.displayRes == VSYS_STD_XGA_60)
    {
        pFormat->width = 1024;
        pFormat->height = 768;
    }
...
#if 1
    Vps_printf(" %d: DISPLAY: %d: Window size %dx%d, %dB,res=%d",
               Utils_getCurTimeInMsec(),
               pObj->displayInstId, pFormat->width, pFormat->height,
               pFormat->pitch[0],pObj->createArgs.displayRes);
#endif
                            ...
                            DisplayLink_CreateParams * pPrm)
{
	...
	Vps_printf("activeQueue = %d, prevLinkQueId = %d, numQue = %d\n",
					pPrm->activeQueue,
					pPrm->inQueParams[pPrm->activeQueue].prevLinkQueId,
