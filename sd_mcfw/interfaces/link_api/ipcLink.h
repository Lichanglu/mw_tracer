...
/** \ IpcFramesOutLinkRTOS command to set Frame Rate */
#define IPCFRAMESOUTRTOS_LINK_CMD_SET_FRAME_RATE     (0x7000)
/** \IpcFramesOutLinkRTOS command to print statistics */
#define IPCFRAMESOUTRTOS_LINK_CMD_PRINT_STATISTICS   (0x7001)

/** \IpcOutM3Link command to set Frame Rate */
#define IPCOUTM3_LINK_CMD_SET_FRAME_RATE             (0x6000)
/** \IpcOutM3Link command to print statistics */
#define IPCOUTM3_LINK_CMD_PRINT_STATISTICS           (0x6001)

/** \IpcBitsOutLink command to print statistics */
...
/**
 * @internal
 * @def SYSTEM_IPC_BITS_SET_BUFOWNERPROCID
...
/**
 * @internal
 * @def SYSTEM_IPC_BITS_SET_BUFSTATE
...
/**
 * @internal
 * @def SYSTEM_IPC_BITS_GET_BUFOWNERPROCID
...
/**
 * @internal
 * @def SYSTEM_IPC_BITS_GET_BUFSTATE
...
/**
 * @internal
 * @def SYSTEM_IPC_FRAMES_SET_BUFOWNERPROCID
...
/**
 * @internal
 * @def SYSTEM_IPC_FRAMES_SET_BUFSTATE
...
/**
 * @internal
 * @def SYSTEM_IPC_FRAMES_GET_BUFOWNERPROCID
...
/**
 * @internal
 * @def SYSTEM_IPC_FRAMES_GET_BUFSTATE
...
/**
    \fn  IpcBitsInLink_getFullVideoBitStream
...
/**
    \fn  IpcBitsInLink_putEmptyVideoBitStream
...
/**
    \fn  IpcBitsOutLink_getInQueInfo
...
/**
    \fn  IpcFramesInLink_getFullVideoFrames
...
/**
    \fn  IpcFramesInLink_putEmptyVideoFrames
...
/**
    \fn  IpcFramesOutLink_getInQueInfo
...
/**
 * \fn IpcLink_CreateParams_Init
 * \Sets default values for IpcLink_CreateParams_Init
 *
 */
...
/**
 * \fn IpcFramesInLinkHLOS_CreateParams_Init
 * \Sets default values for IpcFramesInLinkHLOS_CreateParams_Init
 *
 */
...
/**
 * \fn IpcFramesOutLinkHLOS_CreateParams_Init
 * \Sets default values for IpcFramesOutLinkHLOS_CreateParams
 *
 */
...
/**
 * \fn IpcFramesInLinkRTOS_CreateParams_Init
 * \Sets default values for IpcFramesInLinkRTOS_CreateParams_Init
 *
 */
...
/**
 * \fn IpcFramesOutLinkRTOS_CreateParams_Init
 * \Sets default values for IpcFramesOutLinkRTOS_CreateParams_Init
 *
 */
...
/**
 * \fn IpcBitsInLinkRTOS_CreateParams_Init
 * \Sets default values for IpcFramesOutLinkRTOS_CreateParams_Init
 *
 */
...
/**
 * \fn IpcBitsOutLinkRTOS_CreateParams_Init
 * \Sets default values for IpcBitsOutLinkRTOS_CreateParams_Init
 *
 */
...
/**
 * \fn IpcBitsInLinkHLOS_CreateParams_Init
 * \Sets default values for IpcBitsInLinkHLOS_CreateParams_Init
 *
 */
...
/**
 * \fn IpcBitsOutLinkHLOS_CreateParams_Init
 * \Sets default values for IpcBitsOutLinkHLOS_CreateParams_Init
 *
 */
