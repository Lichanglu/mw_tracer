...
#define CAPTURE_LINK_CMD_A8_DETECT_VIDEO         (0X100F)
#define CAPTURE_LINK_CMD_SET_OUTPUT_FRAMERATE	 (0X1010)
#define CAPTURE_LINK_CMD_CHECK_STATUS			 (0x1011)
...
typedef struct
{
    ...
    UInt32 chId;
	UInt32 framerate;
} CaptureLink_SetChannelFramerate;
