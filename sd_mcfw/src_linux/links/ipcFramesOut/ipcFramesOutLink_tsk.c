...
//	printf("IpcFramesOutLink_periodicTaskFxn = %p\n",IpcFramesOutLink_periodicTaskFxn);
	printf_pthread_create(__FILE__, ("IpcFramesOutLink_periodicTaskFxn"));
...
Int32 IpcFramesOutLink_init()
{
         ...
         ipcFramesOutId++)
    {
        ...
        pObj->startProcessing = FALSE;
	printf_pthread_create(__FILE__, ("IpcFramesOutLink_tskMain"));
