 ...
 * \defgroup DEVICE_DRV_FVID2_DEVICE_VID_DEC_TVP7002_API TVP7002 Video Decoder API
 *
 *  This modules define API specific to TVP7002.
 *
 * @{
*/
 ...
 *
 *  \brief TVP7002 Video Decoder API
*/

#ifndef _DEVICE_TVP7002_H_
#define _DEVICE_TVP7002_H_
...
/**
  * \addtogroup DEVICE_DRV_FVID2_IOCTL_TVP7002
  * @{
*/

/**
  * \brief Set TVP7002 video noise filter parameters
  *
  * This IOCTL can be called separetly for each channel.
  *
  * \param cmdArgs       [IN]   Device_Tvp7002VideoNfParams *
  * \param cmdArgsStatus [OUT]  NULL
  *
  * \return FVID_SOK on success, else failure
  *
*/
#define IOCTL_DEVICE_TVP7002_SET_VIDEO_NF      \
...
/**
  ...
  * This IOCTL can be called separetly for each channel.
  *
  * \param cmdArgs       [IN]   Device_Tvp7002AudioModeParams *
  * \param cmdArgsStatus [OUT]  NULL
  *
  * \return FVID_SOK on success, else failure
  *
*/
#define IOCTL_DEVICE_TVP7002_SET_AUDIO_MODE    \
