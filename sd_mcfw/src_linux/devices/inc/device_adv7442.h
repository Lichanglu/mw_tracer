 ...
 * \defgroup DEVICE_DRV_FVID2_DEVICE_VID_DEC_ADV7442_API ADV7442 Video Decoder API
 *
 *  This modules define API specific to ADV7442.
 *
 * @{
*/

/**
 *  \file Device_adv7442.h
 *
 *  \brief ADV7442 Video Decoder API
*/

#ifndef _DEVICE_ADV7442_H_
#define _DEVICE_ADV7442_H_
...
/**
  * \addtogroup DEVICE_DRV_FVID2_IOCTL_ADV7442
  * @{
*/

/**
  * \brief Set ADV7442 video noise filter parameters
  *
  * This IOCTL can be called separetly for each channel.
  *
  * \param cmdArgs       [IN]   Device_Adv7442VideoNfParams *
  * \param cmdArgsStatus [OUT]  NULL
  *
  * \return FVID_SOK on success, else failure
  *
*/
#define IOCTL_DEVICE_ADV7442_SET_VIDEO_NF      \
...
/**
  ...
  * This IOCTL can be called separetly for each channel.
  *
  * \param cmdArgs       [IN]   Device_Adv7442AudioModeParams *
  * \param cmdArgsStatus [OUT]  NULL
  *
  * \return FVID_SOK on success, else failure
  *
*/
#define IOCTL_DEVICE_ADV7442_SET_AUDIO_MODE    \
...
/**
 * \brief Arguments for IOCTL_DEVICE_ADV7442_SET_VIDEO_NF
*/
typedef struct
{
...
} Device_Adv7442VideoNfParams;

/**
 * \brief Arguments for IOCTL_DEVICE_ADV7442_SET_AUDIO_MODE
 *
...
typedef struct
{
  ...
  /**< Cascade stage number, Valid values: 0..3 */
    ...
    UInt32 audioVolume;
  /**< Audio volume, Valid values: 0..8. Refer to ADV7442 datasheet for details
   */

    UInt32 tdmChannelNum;
    /**< Number of TDM channels: 0: 2CH, 1: 4CH, 2: 8CH, 3: 12CH 4: 16CH */

} Device_Adv7442AudioModeParams;
