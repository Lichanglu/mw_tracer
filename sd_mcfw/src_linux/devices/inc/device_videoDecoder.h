...
#define IOCTL_DEVICE_VIDEO_DECODER_SET_DIRECTION          \
            (DEVICE_VID_DEC_IOCTL_BASE + 0x0A)

#define IOCTL_DEVICE_VIDEO_DECODER_GET_DIRECTION          \
            (DEVICE_VID_DEC_IOCTL_BASE + 0x0B)

#define IOCTL_DEVICE_VIDEO_DECODER_INVERT_CBCR          \
            (DEVICE_VID_DEC_IOCTL_BASE + 0x0C)

#define IOCTL_DEVICE_VIDEO_DECODER_GET_HDCP          \
            (DEVICE_VID_DEC_IOCTL_BASE + 0x0D)

#define IOCTL_DEVICE_VIDEO_DECODER_EXTERN_INFORM          \
            (DEVICE_VID_DEC_IOCTL_BASE + 0x0F)

#define IOCTL_DEVICE_VIDEO_DECODER_SET_SOURCE_CHAN          \
            (DEVICE_VID_DEC_IOCTL_BASE + 0x10)

#define IOCTL_DEVICE_VIDEO_DECODER_GET_SOURCE_CHAN          \
            (DEVICE_VID_DEC_IOCTL_BASE + 0x11)

#define IOCTL_DEVICE_VIDEO_DECODER_CSC          \
            (DEVICE_VID_DEC_IOCTL_BASE + 0x12)
	
#define IOCTL_DEVICE_VIDEO_GET_FPGA_VERSION         \
